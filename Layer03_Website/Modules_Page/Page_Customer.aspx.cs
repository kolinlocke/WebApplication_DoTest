...
{
    public partial class Page_Customer : ClsBasePageList
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                this.pMaster.Setup(
                  Layer01_Common.Common.Layer01_Constants.eSystem_Modules.Mas_Customer
                  , new ClsCustomer(this.pMaster.pCurrentUser)
                  , "Customer");
            }
        }
    }
