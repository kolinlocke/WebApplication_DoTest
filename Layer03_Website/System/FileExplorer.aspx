<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileExplorer.aspx.cs" Inherits="Layer03_Website._System.FileExplorer" %>
...
<HTML>
	<HEAD>
		...
		<link href="../../System/EOWebDemo.css" type="text/css" rel="stylesheet">
	</HEAD>
	<body MS_POSITIONING="GridLayout" style="padding: 4px; margin: 0px; background-color:#f0f0f0" class="normal">
		<form id="Form1" method="post" runat="server">
            ...
            <br />
            <br />
			<eo:FileExplorer id="FileExplorer1" runat="server" RootFolder="~/System/Uploaded/Images" AllowUpload="True"
				EnableKeyboardNavigation="True" MaxUploadFileSize="10000">
				<LayoutTemplate>
					<eo:splitter id="LeftSplitter" runat="server" Height="260px" Width="700px" ControlSkinID="None"
						...
						<eo:SplitterPane id="SplitterPane2" runat="server" Width="400px" ScrollBars="None">
							<eo:Splitter id="RightSplitter" runat="server" Height="100%" Width="100%" ControlSkinID="None"
								...
								<eo:SplitterPane id="SplitterPane3" runat="server" ScrollBars="None">
									<eo:Grid runat="server" id="FileGrid" Height="220px" Width="320px" Font-Size="8.75pt" Font-Names="Tahoma"
									...
									<div id="uploader_div" style="display:none; height:55px">
										<eo:AJAXUploader id="FileUploader" Width="250px" runat="server" AutoUpload="True" HideDisabledToolBarButton="True"
											TempFileLocation="~/System/Temp" ClientSideOnStart="upload_begin" ClientSideOnDone="upload_done"
											ClientSideOnCancel="upload_done" AllowedExtension=".gif|.bmp|.png|.jpg|.jpeg|.tif" FinalFileLocation="~/System/Uploaded/Images" FinalFileList="AJAXPostedFileList1">
											<LayoutTemplate>
                                        ...
                                        <eo:AJAXPostedFileList ID="AJAXPostedFileList1" runat="server" SessionVarName="">
                                        </eo:AJAXPostedFileList>
                                        <eo:Callback ID="EOCb_UploadDone" runat="server">
                                        </eo:Callback>
									</div>
