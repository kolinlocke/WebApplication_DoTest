...
namespace Layer01_Common.DataAccess
{
    public class ClsDataAccess
    {
        ...
        public struct Struct_Parameters
        { 
            public string Name;
            public object Value;

            public Struct_Parameters(string pName, object pValue)
            {
                Name = pName;
                Value = pValue;
            }
        ...
        #region _Methods
            ...
            public int ExecuteNonQuery(string ProcedureName, List<Struct_Parameters> ProcedureParameters)
            {
            ...
            public DataSet ExecuteQuery(string ProcedureName, List<Struct_Parameters> ProcedureParameters)
            {
        ...
        public SqlTransaction pTransaction
        {
