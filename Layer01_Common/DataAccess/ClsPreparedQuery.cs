...
namespace Layer01_Common.DataAccess
{
    public class ClsPreparedQuery
    {
        ...
        public void Add_Parameter(string Name, SqlDbType DbType, Int32 Size, byte Precision, byte Scale, Object Value)
        {
