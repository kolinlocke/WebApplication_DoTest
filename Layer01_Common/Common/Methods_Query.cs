...
namespace Layer01_Common.Common
{
    public class Methods_Query
    {
        ...
        public static DataTable GetQuery(ClsDataAccess Da, string ViewObject, string Fields)
        {
        ...
        public static DataTable GetQueryWithPage(ClsDataAccess Da, string ViewObject, string Fields)
        {
        ...
        public static Int32 ExecuteNonQuery(string ProcedureName, List<ClsDataAccess.Struct_Parameters> ProcedureParameters)
        {
        ...
        public static DataSet ExecuteQuery(string ProcedureName, List<ClsDataAccess.Struct_Parameters> ProcedureParameters)
        {
        ...
        {
            List<ClsDataAccess.Struct_Parameters> Sp = new List<ClsDataAccess.Struct_Parameters>();
            Sp.Add(new ClsDataAccess.Struct_Parameters("@TableName",TableName));
        ...
        public static string GetSystemParameter(string ParameterName)
        {
            string Rv = "";
            List<ClsDataAccess.Struct_Parameters> Sp = new List<ClsDataAccess.Struct_Parameters>();
            Sp.Add(new ClsDataAccess.Struct_Parameters("ParameterName", ParameterName));
