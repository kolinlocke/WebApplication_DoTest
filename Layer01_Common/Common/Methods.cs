...
namespace Layer01_Common.Common
{
    public class Methods
    {
        ...
        public static void AddDataRow(ref DataTable Dt, List<ClsDataAccess.Struct_Parameters> Sp)
        {
            DataRow Nr = Dt.NewRow();
            foreach (ClsDataAccess.Struct_Parameters Obj in Sp)
        ...
        public static double Convert_Double(string value)
        {
        ...
        public static Int64 Convert_Int64(string value)
        {
            Int64 ReturnValue = 0;
